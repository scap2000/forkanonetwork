...
* Aprender cómo crear convertir un nodo validador en un pool de delegación (stake pool)
...
* Crear, acuñar y transferir NFT's or _Non Forkable Tokens_ :)
...
* Se llama CAP © y se representa como una chapita o tapida de botella de Nuka-Cola (véase <a href="https://fallout.fandom.com/wiki/Bottle_cap" target="blank">_Fallout Games_</a>)
* ¿Fallout? ¿Por qué?
    ...
    * ⚡ Curiosidad: Sí, soy fan de Fallout
